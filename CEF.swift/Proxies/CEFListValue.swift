...
public extension CEFListValue {
    ...
    /// and vice-versa.
    /// CEF name: `IsSame`
    func isSame(as other: CEFListValue) -> Bool {
    ...
    /// CEF name: `IsEqual`
    func isEqual(to other: CEFListValue) -> Bool {
    ...
    /// CEF name: `SetSize`
    @available(*, deprecated, message: "use the `size` property")
    @discardableResult
    func setSize(_ size: Int) -> Bool {
    ...
    /// CEF name: `GetType`
    func type(at index: Int) -> CEFValueType {
    ...
    /// CEF name: `GetValue`
    func value(at index: Int) -> CEFValue? {
    ...
    /// CEF name: `GetBinary`
    func binary(at index: Int) -> CEFBinaryValue? {
    ...
    func dictionary(at index: Int) -> CEFDictionaryValue? {
    ...
    /// modify this object.
    /// CEF name: `GetList`
    func list(at index: Int) -> CEFListValue? {
    ...
    /// CEF name: `SetValue`
    @discardableResult
    func set(_ value: CEFValue, at index: Int) -> Bool {
    ...
    /// CEF name: `SetNull`
    @discardableResult
    func setNull(at index: Int) -> Bool {
    ...
    /// CEF name: `SetBool`
    @discardableResult
    func set(_ value: Bool, at index: Int) -> Bool {
    ...
    /// CEF name: `SetDouble`
    @discardableResult
    func set(_ value: Double, at index: Int) -> Bool {
    ...
    /// CEF name: `SetString`
    @discardableResult
    func set(_ string: String, at index: Int) -> Bool {
    ...
    /// CEF name: `SetBinary`
    @discardableResult
    func set(_ value: CEFBinaryValue, at index: Int) -> Bool {
    ...
    @discardableResult
    func set(_ value: CEFDictionaryValue, at index: Int) -> Bool {
    ...
    /// CEF name: `SetList`
    @discardableResult
    func set(_ value: CEFListValue, at index: Int) -> Bool {
