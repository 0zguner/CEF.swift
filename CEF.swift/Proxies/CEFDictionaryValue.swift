...
public extension CEFDictionaryValue {
    ...
    /// and vice-versa.
    /// CEF name: `IsSame`
    func isSame(as other: CEFDictionaryValue) -> Bool {
    ...
    /// CEF name: `IsEqual`
    func isEqual(to other: CEFDictionaryValue) -> Bool {
    ...
    /// CEF name: `GetType`
    func type(for key: String) -> CEFValueType {
        let cefKeyPtr = CEFStringPtrCreateFromSwiftString(key)
        defer { CEFStringPtrRelease(cefKeyPtr) }
    ...
    /// CEF name: `GetValue`
    func value(for key: String) -> CEFValue? {
        let cefKeyPtr = CEFStringPtrCreateFromSwiftString(key)
        defer { CEFStringPtrRelease(cefKeyPtr) }
    ...
    /// CEF name: `GetBinary`
    func binary(for key: String) -> CEFBinaryValue? {
        let cefKeyPtr = CEFStringPtrCreateFromSwiftString(key)
        defer { CEFStringPtrRelease(cefKeyPtr) }
    ...
    func dictionary(for key: String) -> CEFDictionaryValue? {
        let cefKeyPtr = CEFStringPtrCreateFromSwiftString(key)
        defer { CEFStringPtrRelease(cefKeyPtr) }
    ...
    /// this object.
    /// CEF name: `GetList`
    func list(for key: String) -> CEFListValue? {
        let cefKeyPtr = CEFStringPtrCreateFromSwiftString(key)
        defer { CEFStringPtrRelease(cefKeyPtr) }
    ...
    /// CEF name: `SetValue`
    @discardableResult
    func set(_ value: CEFValue, for key: String) -> Bool {
        let cefKeyPtr = CEFStringPtrCreateFromSwiftString(key)
        defer { CEFStringPtrRelease(cefKeyPtr) }
    ...
    /// CEF name: `SetNull`
    @discardableResult
    func setNull(for key: String) -> Bool {
        let cefKeyPtr = CEFStringPtrCreateFromSwiftString(key)
        defer { CEFStringPtrRelease(cefKeyPtr) }
    ...
    /// CEF name: `SetDouble`
    @discardableResult
    func set(_ value: Double, for key: String) -> Bool {
        let cefKeyPtr = CEFStringPtrCreateFromSwiftString(key)
        defer { CEFStringPtrRelease(cefKeyPtr) }
    ...
    /// CEF name: `SetBinary`
    @discardableResult
    func set(_ value: CEFBinaryValue, for key: String) -> Bool {
        let cefKeyPtr = CEFStringPtrCreateFromSwiftString(key)
        defer { CEFStringPtrRelease(cefKeyPtr) }
    ...
    @discardableResult
    func set(_ value: CEFDictionaryValue, for key: String) -> Bool {
        let cefKeyPtr = CEFStringPtrCreateFromSwiftString(key)
        defer { CEFStringPtrRelease(cefKeyPtr) }
    ...
    /// CEF name: `SetList`
    @discardableResult
    func set(_ value: CEFListValue, for key: String) -> Bool {
        let cefKeyPtr = CEFStringPtrCreateFromSwiftString(key)
        defer { CEFStringPtrRelease(cefKeyPtr) }
