...
public extension CEFDOMNode {
    ...
    /// object.
    /// CEF name: `IsSame`
    func isSame(as other: CEFDOMNode) -> Bool {
    ...
    /// CEF name: `SetValue`
    @discardableResult
    func setStringValue(_ value: String) -> Bool {
    ...
    var previousSibling: CEFDOMNode? {
    ...
    func elementAttribute(named: String) -> String? {
    ...
    @discardableResult
    func setElementAttribute(_ value: String, for name: String) -> Bool {
        let cefNamePtr = CEFStringPtrCreateFromSwiftString(name)
