...
public extension CEFBrowser {
    ...
    func reload(ignoringCache ignore: Bool = false) {
        if ignore {
    ...
    /// object.
    /// CEF name: `IsSame`
    func isSame(as other: CEFBrowser) -> Bool {
    ...
    /// CEF name: `GetFrame`
    func frame(id: CEFFrame.Identifier) -> CEFFrame? {
    ...
    /// CEF name: `GetFrame`
    func frame(named: String) -> CEFFrame? {
    ...
    var frameIDs: [CEFFrame.Identifier] {
