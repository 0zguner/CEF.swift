...
public extension CEFPrintSettings {
    ...
    var orientation: CEFPageOrientation {
    ...
    func setPrinterPrintableArea(physicalSize: NSSize, printableArea: NSRect, landscapeNeedsFlip: Bool) {
