...
public extension CEFBinaryValue {
    ...
    /// |data| will be copied.
    /// CEF name: `Create`
    convenience init?(data: UnsafeRawPointer, size: size_t) {
    ...
    /// data.
    /// CEF name: `IsSame`
    func isSame(as other: CEFBinaryValue) -> Bool {
    ...
    /// CEF name: `IsEqual`
    func isEqual(to other: CEFBinaryValue) -> Bool {
    ...
    /// CEF name: `GetData`
    func getData(buffer: UnsafeMutableRawPointer, size: size_t, offset: size_t) -> size_t {
